...
To interact with the servers, use an A2AClient in a host app (such as the CLI). See [Host Apps](/agents/python/hosts/README.md) for details.

* [**Google ADK**](/agents/python/agents/google_adk/README.md)  
