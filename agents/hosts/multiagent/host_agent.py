...
class HostAgent:
  ...
  This is the agent responsible for choosing which remote implementation to send
  ...
  def create_agent(self) -> Agent:
    return Agent(
        ...
        description=(
            ...
            " tasks that can be performed by the child implementation."
        ),
        tools=[
...
appropriate remote implementation.

Discovery:
- You can use `list_remote_agents` to list the available remote implementation you
can use to delegate the task.

Execution:
- For actionable tasks, you can use `create_task` to assign tasks to remote implementation to perform.
...
"""
  ...
  def list_remote_agents(self):
    """List the available remote implementation you can use to delegate the task."""
